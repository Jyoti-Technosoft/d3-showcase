...
function DeleteModalGroup({ show, setShow, handleClose }) {
  const { deleteId, setShowToast, setGroupDataSet, setUpdateDataGroup } =
    useContext(CustomContext);

  const deleteData = () => {
    setGroupDataSet((current) => current.filter((ele) => ele.id !== deleteId));
